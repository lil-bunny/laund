...
const Dashboard = () => {
    ...
    const change_pie_chart = (event) => {
        if (event.target.value != '') {
            setPaiChartTime(event.target.value)
        }
        else {
            setPaiChartTime('year');
        }
    };
            ...
            <section className="content dash-content">
                <div className="container-fluid">
                    <div className="row">
                        ...
                        <div className="col-lg-6 col-md-6">
                            <div className="top-content-box">
                                <h3>Delivered Today/Pending Orders</h3>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-6 col-md-6">
                            <div className="top-content-box">
                                <h3>Customer Pending Bills (in Rs.) </h3>
                        ...
                        <div className="col-lg-6 col-md-6">
                            <div className="top-content-box">
                                <h3>Laundry Pending Bills (in Rs.) </h3>
                        ...
                        <div className="col-lg-6 col-md-12">
                            <div className="mid-content-box">
                                <div className="pie-chart-container">
                                    ...
                                    <div className="select-dropdown table-select">
                                        <img src={imageLocation + 'sort-down-small.png'} alt="sort-img" />
                                        <select className="select" onChange={change_pie_chart}>
                                            <option value="week">This Week</option>
                                            <option value="month">This Month</option>
                                            <option value="year">This Year</option>
                                        </select>
